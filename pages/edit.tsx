        ...
        <div className={`${theme === 'dark' ? 'bg-transparent' : 'bg-white'}`}>
          ...
          <div className="flex items-center">
            <Button
              ...
              type={currentTabs === 'HEADER' ? 'primary' : 'secondary'}
            >
              Header
            </Button>
            <Button
              onClick={() => setCurrentTabs('PROJECTS')}
              type={currentTabs === 'PROJECTS' ? 'primary' : 'secondary'}
            >
              Projects
            </Button>
            <Button
              onClick={() => setCurrentTabs('SERVICES')}
              type={currentTabs === 'SERVICES' ? 'primary' : 'secondary'}
            >
              Services
            </Button>
            <Button
              onClick={() => setCurrentTabs('ABOUT')}
              type={currentTabs === 'ABOUT' ? 'primary' : 'secondary'}
            >
              About
            </Button>
            <Button
              onClick={() => setCurrentTabs('SOCIAL')}
              type={currentTabs === 'SOCIAL' ? 'primary' : 'secondary'}
            >
              Social
            </Button>
            <Button
              onClick={() => setCurrentTabs('RESUME')}
              type={currentTabs === 'RESUME' ? 'primary' : 'secondary'}
            >
              Resume
            </Button>
          </div>
            ...
            <div className="mt-5 flex items-center">
              ...
              <div className="w-4/5 ml-10 flex items-center">
                <Button
                  ...
                  type={data.showBlog ? 'primary' : 'secondary'}
                >
                  Yes
                </Button>
                <Button
            ...
            <div className="mt-5 flex items-center">
              ...
              <div className="w-4/5 ml-10 flex items-center">
                <Button
                  ...
                  type={data.darkMode ? 'primary' : 'secondary'}
                >
                  Yes
                </Button>
                <Button
            ...
            <div className="mt-5 flex items-center">
              ...
              <div className="w-4/5 ml-10 flex items-center">
                <Button
                  ...
                  type={data.showResume ? 'primary' : 'secondary'}
                >
                  Yes
                </Button>
                <Button
            ...
            <div className="mt-5 flex items-center">
              ...
              <div className="w-4/5 ml-10 flex items-center">
                <Button
                  ...
                  type={data.showCursor ? 'primary' : 'secondary'}
                >
                  Yes
                </Button>
                <Button
