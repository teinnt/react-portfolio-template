    ...
    <>
      ...
      <div className={`container mx-auto mt-10 ${data.showCursor && 'cursor-none'}`}>
        ...
        <div className="mt-10 flex flex-col">
          <img className="w-full h-96 rounded-lg shadow-lg object-cover" src={post.image} alt={post.title} />
      ...
      {showEditor && <BlogEditor post={post} close={() => setShowEditor(false)} refresh={() => router.reload()} />}
    </>
  )
}
